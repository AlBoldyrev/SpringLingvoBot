...
public class PronounSetup implements SettingsSetupState {
    ...
    public void handle(User user, GroupActor groupActor, DialogState dialogState, UserDialog greetingSetUpDialog) {
        ...
        customButtons.add(new CustomButton("Ты", KeyboardButtonActionType.TEXT, KeyboardButtonColor.DEFAULT, ""));
        customButtons.add(new CustomButton("Вы", KeyboardButtonActionType.TEXT, KeyboardButtonColor.DEFAULT, ""));
