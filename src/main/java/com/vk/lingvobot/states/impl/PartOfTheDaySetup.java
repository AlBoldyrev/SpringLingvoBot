...
public class PartOfTheDaySetup implements SettingsSetupState {
    ...
    public void handle(User user, GroupActor groupActor, DialogState dialogState, UserDialog greetingSetUpDialog) {
        ...
        customButtons.add(new CustomButton("Утром", KeyboardButtonActionType.TEXT, KeyboardButtonColor.DEFAULT, ""));
        customButtons.add(new CustomButton("Днём", KeyboardButtonActionType.TEXT, KeyboardButtonColor.DEFAULT, ""));
        customButtons.add(new CustomButton("Вечером", KeyboardButtonActionType.TEXT, KeyboardButtonColor.DEFAULT, ""));
        buttons.add(customButtons);

        messageService.sendMessageWithTextAndKeyboard(
                groupActor, user.getVkId(), dialogState.getDialogPhrase().getDialogPhraseValue(), buttons);
